...
import { CheckCircle2, AlertCircle, Loader2, Plus, Trash2, MapPin, Camera } from 'lucide-react';
...
function StepIndicator({ number, title, children }: { number: string; title: string; children: React.ReactNode }) {
  return (
    <Card>
