...
export default function Dashboard() {
  ...
  const [selectedCommodity1, setSelectedCommodity1] = useState<string>("Beras");
  const [selectedCommodity2, setSelectedCommodity2] = useState<string>("Cabe Rawit");
  const [selectedCommodityForBar, setSelectedCommodityForBar] = useState<string>("");
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <CommodityLineChartWithSelector
                title="Grafik Harga Komoditas 1"
