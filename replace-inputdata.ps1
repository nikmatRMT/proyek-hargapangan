Write-Host "Replacing InputData.tsx with new version..." -ForegroundColor Yellow
...
$targetPath = "d:\proyek-hargapangan\web-admin\src\pages\InputData.tsx"
Set-Content -Path $targetPath -Value $newContent -Encoding UTF8
Write-Host "Done! File replaced successfully." -ForegroundColor Green
